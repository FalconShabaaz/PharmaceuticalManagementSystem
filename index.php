...
<body>
        ...
        <div class="topber__profile">
            <?php
                ...
                if ( $data = mysqli_fetch_assoc( $result ) ) {
                    ...
                    $avatar = $data['avatar'];
                ?>
                <img src="assets/img/adminlogo.png"<?php echo "$avatar"; ?>" height="25" width="25" class="rounded-circle" alt="profile">
                <div class="dropdown">
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"><i id="left"><img src="assets/img/logo1.jpg" alt="logo"></i> Pharmacy</h3>
    ...
    echo " active";
        ...
        <footer class="text-center"><span>PMS</span><br>©2022 PMS All right reserved.<br>Made with ❤️ by Mohammed Shabaaz</footer>
    </section>
    <!--------------------------------- #Sidebar -------------------------------->
                        ...
                        <form action="index.php">
                            ...
                            <div class="form-row text-center">
                                <div class="col col-12 text-center pb-3">
                                    <img src="assets/img/adminlogo.png"<?php echo $data['avatar']; ?>" class="img-fluid rounded-circle" alt="">
                                </div>
                                <div class="col col-12">
